...
Este repositorio contiene un proyecto práctico enfocado en el aprendizaje y la aplicación de comandos fundamentales de SQL (**CRUD**: *Create, Read, Update, Delete*) utilizando una base de datos relacional. El objetivo es simular la creación y administración de una lista de contactos o amigos desde cero.
